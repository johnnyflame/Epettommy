...
var tommy_home = (function (_super) {
    ...
    function tommy_home(app) {
        ...
        this.add(top_carret);
        var food_label = new label("Feed", "10px sans-serif", "#FFFFFF", "center");
        food_label.set_position(left_carret.width / 2, (h - left_carret.height) / 2);
        this.add(food_label);
        var stat_label = new label("Stats", "10px sans-serif", "#FFFFFF", "center");
        stat_label.set_position((w - right_carret.width / 2), (h - left_carret.height) / 2);
        this.add(stat_label);
        var game_label = new label("Play", "10px sans-serif", "#FFFFFF", "center");
...
var tommy_stats = (function (_super) {
    ...
    function tommy_stats(app) {
        ...
        var text = new label("Health", "10px sans-serif", "#FFFFFF", "right");
